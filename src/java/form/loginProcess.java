...
public class loginProcess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<String> loggedIn = (ArrayList<String>)request.getServletContext().getAttribute("loggedIn");
            //UserMap map = (UserMap)session.getAttribute("map");
            UserMap map = UserMap.getInstance();
            
            if (map.checkExist(username, password)) {
                ...
                response.sendRedirect("/PRJ321x-A3/index.jsp");
            } else {
